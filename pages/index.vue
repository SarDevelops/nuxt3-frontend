    ...
    <div class="main-content">
      ...
      <article class="about active" data-page="about">
        ...
        <section class="clients">
          <h3 class="h3 clients-title">Companies</h3>

          <ul class="clients-list has-scrollbar">
            <li class="clients-item">
              <a href="https://www.hulkapps.com/">
                <img src="~/assets/images/hulkapps.svg" alt="client logo" />
              </a>
            </li>

            <li class="clients-item">
              <a href="https://www.narolainfotech.com/">
                <img src="~/assets/images/narola.svg" alt="client logo" />
              </a>
            </li>

            <li class="clients-item">
              <a href="https://techvizor.in/">
                <img src="~/assets/images/techvizor.svg" alt="client logo" />
              </a>
            </li>
